...
| 层级 | 路径 | 用途 |
| --- | --- | --- |
| **指令 / 记忆** | `AGENTS.md`、`instructions/` | 定义角色、流程、回答规范 |
...
1. **判断场景**（电商中文 / Bazaar·附件核对 / 英文邮件 / 非技术转交）
...
默认中文；可按买家或邮件语言切换。淘宝/天猫回复要短、可直接复制到聊天窗口。

## 知识库更新

核对确认的新结论可写入 `docs/`，并更新 `INDEX.md`；不确定的放 `docs/unknown_review/`。
